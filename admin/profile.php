                    ...
                    <table class="table table-borderless datatable">
                      ...
                      <tbody>
                        <?php
                          ...
                          ?>
                                <tr>
                                  <td><?php $formattedDate = date("F d, Y", strtotime($row["leave_filed"])); echo $formattedDate?></td>
                                  <td><?php echo $row["leave_type"]?></a></td>
                                  <td><?php echo $row["leave_duration"]?></td>
                                  <td><?php $formattedDate = date("F d, Y", strtotime($row["leave_start"])); echo $formattedDate?></td>
                                  <td><?php $formattedDate = date("F d, Y", strtotime($row["leave_end"])); echo $formattedDate?></td>
